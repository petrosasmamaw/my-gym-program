...
export default function DesktopVideoEmbed({ videoId, label, accent }) {
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="relative overflow-hidden rounded-xl border border-edge bg-panel aspect-[9/16] h-[380px] w-[214px] shrink-0">
